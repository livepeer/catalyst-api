...
func main() {
	...
	fs.Float64Var(&cli.NoMistRedirectThresholdPercent, "no-mist-redirect-threshold-percent", 80, "Max CPU/Mem Load Percentage for which MistUtilLoad should not redirect")
