...
func main() {
	...
	fs.IntVar(&config.MaxInFlightClipJobs, "max-inflight-clip-jobs", 50, "Maximum number of concurrent clipping jobs to support in catalyst-api")
	...
	fs.IntVar(&cli.SerfQueueSize, "serf-queue-size", 20, "Size of internal serf queue before user events are dropped")
